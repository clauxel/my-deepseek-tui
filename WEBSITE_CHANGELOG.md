...
Scope: repaired P0/P1 checklist issues for deepseek-tui.space.

Touched files:
  - deepseek-tui/dist/index.html
...
- Added one contextual related-resource link to MiroFish AI Simulator with UTM tracking for deepseek-tui.space.
